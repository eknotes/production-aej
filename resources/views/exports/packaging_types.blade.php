...
<head>
    <title>Laporan Data Jenis Kemasan</title>
    <style>
...
<body>
    ...
    <main>
        <h3 style="text-align: center; margin-top: 0; margin-bottom: 10px;">LAPORAN DATA JENIS KEMASAN</h3>
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th>Nama Kemasan</th>
                    <th width="25%" style="text-align: center">Isi Per Unit</th>
