...
<head>
    <title>Laporan Data Downtime</title>
    <style>
...
<body>
        ...
        <table class="kop-table">
            <tr>
                ...
                <td class="company-info">
                    <div class="company-name">PT. PRODUKSI EK DEV STUDIO</div>
    ...
    <main>
        <h3 style="text-align: center; margin-top: 0; margin-bottom: 10px;">LAPORAN DATA DOWNTIME</h3>

        <table class="data-table">
            <thead>
                <tr>
                    <th width="5%" style="text-align: center">No</th>
                    <th>Alasan Downtime</th>
