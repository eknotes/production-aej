<table>
    <thead>
        <tr>
            {{-- colspan="4" karena kolom tabel ada 4 (No, Nama, Isi, Status) --}}
        ...
        <tr>
            ...
            <th style="font-weight: bold; text-align: center; border: 1px solid #000000; background-color: #cccccc;">Nama
                Kemasan</th>
            <th style="font-weight: bold; text-align: center; border: 1px solid #000000; background-color: #cccccc;">Isi
                Per Unit</th>
    ...
    <tbody>
        @foreach ($packagingTypes as $key => $type)
            <tr>
                <td style="text-align: center; border: 1px solid #000000;">{{ $key + 1 }}</td>
                <td style="border: 1px solid #000000;">{{ $type->name }}</td>
                <td style="text-align: center; border: 1px solid #000000;">
                    {{ number_format($type->conversion_quantity, 0, ',', '.') }} {{ $type->content_unit }}
                </td>
                <td style="text-align: center; border: 1px solid #000000;">
