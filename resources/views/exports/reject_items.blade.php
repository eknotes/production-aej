...
<head>
    <title>Laporan Data Reject Items</title>
    <style>
...
<body>
    ...
    <main>
        <h3 style="text-align: center; margin-top: 0; margin-bottom: 10px;">LAPORAN DATA REJECT ITEMS</h3>

        <table class="data-table">
            <thead>
                <tr>
                    <th width="5%" style="text-align: center">No</th>
                    <th>Nama Item Reject</th>
                    <th width="25%">Kategori</th>
                    <th width="15%" style="text-align: center">Status</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($rejectItems as $key => $item)
                    <tr>
